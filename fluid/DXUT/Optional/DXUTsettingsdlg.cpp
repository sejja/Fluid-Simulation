...
WCHAR* DXUTAPIVersionToString( DXUTDeviceVersion version )
{
    ...
    {
        case DXUT_D3D9_DEVICE:
            return (wchar_t*)L"Direct3D 9";
        case DXUT_D3D10_DEVICE:
            return (wchar_t*)L"Direct3D 10";
        default:
            return (wchar_t*)L"Unknown version";
    }
}
...
WCHAR* DXUTD3DDeviceTypeToString( D3DDEVTYPE devType )
{
    ...
    {
        case D3DDEVTYPE_HAL:
            return (wchar_t*)L"D3DDEVTYPE_HAL";
        case D3DDEVTYPE_SW:
            return (wchar_t*)L"D3DDEVTYPE_SW";
        case D3DDEVTYPE_REF:
            return (wchar_t*)L"D3DDEVTYPE_REF";
        default:
            return (wchar_t*)L"Unknown devType";
    }
}
...
WCHAR* DXUTD3DX10DeviceTypeToString( D3D10_DRIVER_TYPE devType )
{
    switch( devType )
    {
        case D3D10_DRIVER_TYPE_HARDWARE:
            return (wchar_t*)L"D3D10_DRIVER_TYPE_HARDWARE";
        case D3D10_DRIVER_TYPE_REFERENCE:
            return (wchar_t*)L"D3D10_DRIVER_TYPE_REFERENCE";
        case D3D10_DRIVER_TYPE_SOFTWARE:
            return (wchar_t*)L"D3D10_DRIVER_TYPE_WARP";
        case D3D10_DRIVER_TYPE_NULL:
            return (wchar_t*)L"D3D10_DRIVER_TYPE_NULL";
        default:
            return (wchar_t*)L"Unknown devType";
    }
}
...
WCHAR* DXUTMultisampleTypeToString( D3DMULTISAMPLE_TYPE MultiSampleType )
{
    switch( MultiSampleType )
    {
        case D3DMULTISAMPLE_NONE:
            return (wchar_t*)L"D3DMULTISAMPLE_NONE";
        case D3DMULTISAMPLE_NONMASKABLE:
            return (wchar_t*)L"D3DMULTISAMPLE_NONMASKABLE";
        case D3DMULTISAMPLE_2_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_2_SAMPLES";
        case D3DMULTISAMPLE_3_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_3_SAMPLES";
        case D3DMULTISAMPLE_4_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_4_SAMPLES";
        case D3DMULTISAMPLE_5_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_5_SAMPLES";
        case D3DMULTISAMPLE_6_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_6_SAMPLES";
        case D3DMULTISAMPLE_7_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_7_SAMPLES";
        case D3DMULTISAMPLE_8_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_8_SAMPLES";
        case D3DMULTISAMPLE_9_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_9_SAMPLES";
        case D3DMULTISAMPLE_10_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_10_SAMPLES";
        case D3DMULTISAMPLE_11_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_11_SAMPLES";
        case D3DMULTISAMPLE_12_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_12_SAMPLES";
        case D3DMULTISAMPLE_13_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_13_SAMPLES";
        case D3DMULTISAMPLE_14_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_14_SAMPLES";
        case D3DMULTISAMPLE_15_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_15_SAMPLES";
        case D3DMULTISAMPLE_16_SAMPLES:
            return (wchar_t*)L"D3DMULTISAMPLE_16_SAMPLES";
        default:
            return (wchar_t*)L"Unknown Multisample Type";
    }
}
...
WCHAR* DXUTVertexProcessingTypeToString( DWORD vpt )
{
    switch( vpt )
    {
        case D3DCREATE_SOFTWARE_VERTEXPROCESSING:
            return (wchar_t*)L"Software vertex processing";
        case D3DCREATE_MIXED_VERTEXPROCESSING:
            return (wchar_t*)L"Mixed vertex processing";
        case D3DCREATE_HARDWARE_VERTEXPROCESSING:
            return (wchar_t*)L"Hardware vertex processing";
        case D3DCREATE_PUREDEVICE:
            return (wchar_t*)L"Pure hardware vertex processing";
        default:
            return (wchar_t*)L"Unknown vertex processing type";
    }
}
...
WCHAR* DXUTPresentIntervalToString( UINT pi )
{
    switch( pi )
    {
        case D3DPRESENT_INTERVAL_IMMEDIATE:
            return (wchar_t*)L"D3DPRESENT_INTERVAL_IMMEDIATE";
        case D3DPRESENT_INTERVAL_DEFAULT:
            return (wchar_t*)L"D3DPRESENT_INTERVAL_DEFAULT";
        case D3DPRESENT_INTERVAL_ONE:
            return (wchar_t*)L"D3DPRESENT_INTERVAL_ONE";
        case D3DPRESENT_INTERVAL_TWO:
            return (wchar_t*)L"D3DPRESENT_INTERVAL_TWO";
        case D3DPRESENT_INTERVAL_THREE:
            return (wchar_t*)L"D3DPRESENT_INTERVAL_THREE";
        case D3DPRESENT_INTERVAL_FOUR:
            return (wchar_t*)L"D3DPRESENT_INTERVAL_FOUR";
        default:
            return (wchar_t*)L"Unknown PresentInterval";
    }
}
