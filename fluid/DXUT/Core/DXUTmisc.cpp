...
WCHAR* WINAPI DXUTTraceD3DDECLMETHODtoString( BYTE m )
{
    switch( m )
    {
        case D3DDECLMETHOD_DEFAULT:
            return (wchar_t*)L"D3DDECLMETHOD_DEFAULT";
        case D3DDECLMETHOD_PARTIALU:
            return (wchar_t*)L"D3DDECLMETHOD_PARTIALU";
        case D3DDECLMETHOD_PARTIALV:
            return (wchar_t*)L"D3DDECLMETHOD_PARTIALV";
        case D3DDECLMETHOD_CROSSUV:
            return (wchar_t*)L"D3DDECLMETHOD_CROSSUV";
        case D3DDECLMETHOD_UV:
            return (wchar_t*)L"D3DDECLMETHOD_UV";
        case D3DDECLMETHOD_LOOKUP:
            return (wchar_t*)L"D3DDECLMETHOD_LOOKUP";
        case D3DDECLMETHOD_LOOKUPPRESAMPLED:
            return (wchar_t*)L"D3DDECLMETHOD_LOOKUPPRESAMPLED";
        default:
            return (wchar_t*)L"D3DDECLMETHOD Unknown";
    }
}
...
WCHAR* WINAPI DXUTTraceD3DDECLUSAGEtoString( BYTE u )
{
    switch( u )
    {
        case D3DDECLUSAGE_POSITION:
            return (wchar_t*)L"D3DDECLUSAGE_POSITION";
        case D3DDECLUSAGE_BLENDWEIGHT:
            return (wchar_t*)L"D3DDECLUSAGE_BLENDWEIGHT";
        case D3DDECLUSAGE_BLENDINDICES:
            return (wchar_t*)L"D3DDECLUSAGE_BLENDINDICES";
        case D3DDECLUSAGE_NORMAL:
            return (wchar_t*)L"D3DDECLUSAGE_NORMAL";
        case D3DDECLUSAGE_PSIZE:
            return (wchar_t*)L"D3DDECLUSAGE_PSIZE";
        case D3DDECLUSAGE_TEXCOORD:
            return (wchar_t*)L"D3DDECLUSAGE_TEXCOORD";
        case D3DDECLUSAGE_TANGENT:
            return (wchar_t*)L"D3DDECLUSAGE_TANGENT";
        case D3DDECLUSAGE_BINORMAL:
            return (wchar_t*)L"D3DDECLUSAGE_BINORMAL";
        case D3DDECLUSAGE_TESSFACTOR:
            return(wchar_t*)L"D3DDECLUSAGE_TESSFACTOR";
        case D3DDECLUSAGE_POSITIONT:
            return (wchar_t*)L"D3DDECLUSAGE_POSITIONT";
        case D3DDECLUSAGE_COLOR:
            return (wchar_t*)L"D3DDECLUSAGE_COLOR";
        case D3DDECLUSAGE_FOG:
            return (wchar_t*)L"D3DDECLUSAGE_FOG";
        case D3DDECLUSAGE_DEPTH:
            return (wchar_t*)L"D3DDECLUSAGE_DEPTH";
        case D3DDECLUSAGE_SAMPLE:
            return (wchar_t*)L"D3DDECLUSAGE_SAMPLE";
        default:
            return (wchar_t*)L"D3DDECLUSAGE Unknown";
    }
}
