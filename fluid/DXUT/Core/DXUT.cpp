                           ...
                           bool bIgnoreFirstCommand )
{
    ...
    for( int iArg = iArgStart; iArg < nNumArgs; iArg++ )
    {
        ...
        if( *strCmdLine == L'/' || *strCmdLine == L'-' )
        {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forceapi" ) )
            {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"adapter" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"windowed" ) )
            {
                GetDXUTState().SetOverrideWindowed( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"output" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"fullscreen" ) )
            {
                GetDXUTState().SetOverrideFullScreen( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forcehal" ) )
            {
                GetDXUTState().SetOverrideForceHAL( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forceref" ) )
            {
                GetDXUTState().SetOverrideForceREF( true );
                continue;
            }

			if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forcewarp" ) )
            {
				GetDXUTState().SetOverrideForceWARP( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forcepurehwvp" ) )
            {
                GetDXUTState().SetOverrideForcePureHWVP( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forcehwvp" ) )
            {
                GetDXUTState().SetOverrideForceHWVP( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forceswvp" ) )
            {
                GetDXUTState().SetOverrideForceSWVP( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"forcevsync" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"width" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"height" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"startx" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"starty" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"constantframetime" ) )
            {
                float fTimePerFrame;
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"quitafterframe" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
            ...
            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"noerrormsgboxes" ) )
            {
                GetDXUTState().SetShowMsgBoxOnError( false );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"nostats" ) )
            {
                GetDXUTState().SetNoStats( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"relaunchmce" ) && GetSystemMetrics( SM_MEDIACENTER ) != 0 )
            {
                GetDXUTState().SetOverrideRelaunchMCE( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, (wchar_t*)L"automation" ) )
            {
...
LPCWSTR WINAPI DXUTGetFrameStats( bool bShowFPS )
{
    ...
    WCHAR* pstrFPS = ( bShowFPS ) ? GetDXUTState().GetFPSStats() : (wchar_t*)L"";
